import {integer, varchar,serial, pgTable, text, timestamp, jsonb, boolean} from 'drizzle-orm/pg-core'
...
export const CollectedWastes = pgTable('collected_waste',{
    ...
    collectionsDate: timestamp('collections_date').defaultNow().notNull(),
